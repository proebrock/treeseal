...
class TestDir(object):
	...
	def create(self):
		...
		self.down('Content')
		self.mkfile('Missing_NoBackup')
		self.mkfile('Missing_WithBackup')
		self.mkfile('Ok')
	...
	def change(self):
		...
		self.rmfile('Missing_NoBackup')
		self.cpfile('Missing_WithBackup', 'Missing_WithBackup.bak')
		self.rmfile('Missing_WithBackup')
